...
(function($PS) {
  ...
  var Recipient = function (x) {
      return x;
  };
  var Message = function (x) {
      return x;
  };
  var SendOut = function (x) {
      return x;
  };
  ...
  var renderableMessage = new Renderable(function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.table_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("ID:") ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showString)(v.id)) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text("Text:") ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showString)(v.text)) ]) ]) ]) ]);
  });
  ...
  exports["mkMyComponent"] = mkMyComponent;
  ...
  exports["renderableRecipients"] = renderableRecipients;
  exports["renderableMessage"] = renderableMessage;
})(PS);
PS["Main"].main();