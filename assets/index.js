...
(function($PS) {
  ...
  var MarkAsRead = (function () {
      function MarkAsRead(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      MarkAsRead.create = function (value0) {
          return function (value1) {
              return new MarkAsRead(value0, value1);
          };
      };
      return MarkAsRead;
  })();
  var interpretDSLF = function (v) {
      if (v instanceof CheckInbox) {
          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity)))(function (inbox) {
              return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(v.value0(inbox));
          });
      };
      if (v instanceof SendMessage) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Data_Array.cons(v.value0)))(function () {
              return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(v.value1);
          });
      };
      if (v instanceof MarkAsRead) {
      ...
      throw new Error("Failed pattern match at DSL (line 73, column 1 - line 73, column 58): " + [ v.constructor.name ]);
  };
  var functorDSLF = new Data_Functor.Functor(function (f) {
      return function (m) {
          if (m instanceof CheckInbox) {
              return new CheckInbox(Data_Functor.map(Data_Functor.functorFn)(f)(m.value0));
          };
          if (m instanceof SendMessage) {
              return new SendMessage(m.value0, f(m.value1));
          };
          if (m instanceof MarkAsRead) {
              return new MarkAsRead(m.value0, f(m.value1));
          };
          throw new Error("Failed pattern match at DSL (line 39, column 1 - line 39, column 44): " + [ m.constructor.name ]);
      };
  });
  var interpretDSL = function (dsl) {
      return Control_Monad_Free.runFreeM(functorDSLF)(Control_Monad_State_Trans.monadRecStateT(Control_Monad_Rec_Class.monadRecIdentity))(interpretDSLF)(dsl);
  };
  var runDSL = function (initial) {
      return function (dsl) {
          var x = Control_Monad_State.evalState(interpretDSL(dsl))(initial);
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(x);
      };
  };
  var checkInbox = Control_Monad_Free.liftF(new CheckInbox(Control_Category.identity(Control_Category.categoryFn)));
  exports["runDSL"] = runDSL;
      ...
      var renderRecipientAndInbox = function (inboxes) {
          return function (v) {
              var showInbox = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Dashboard (line 93, column 9 - line 93, column 43): " + [ v1.constructor.name ]);
              };
      ...
      var renderNav = (function () {
          ...
          var renderNavItem = function (sendout) {
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link" + (function () {
                  var $20 = Data_Eq.eq(DataModel.eqSendOut)(sendout)(state.activeSendout);
                  if ($20) {
                      return " active";
                  };
                  return "";
  ...
  var handleAction = function (v) {
      if (v instanceof SwitchTab) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $28.activeSendout = v.value0;
              return $28;
          });
      };
      if (v instanceof CheckInbox) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Control_Monad_Free.freeMonad)(DSL.checkInbox))(function (inbox) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $32 = {};
                  for (var $33 in st) {
                  ...
                  $32.inboxes = Data_Map_Internal.insert(DataModel.ordUser)(v.value0)(inbox)(st.inboxes);
                  return $32;
              });
          });
      };
      throw new Error("Failed pattern match at Dashboard (line 139, column 16 - line 144, column 67): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var main = (function () {
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(DSL.runDSL([ DataModel.mkMessage("hi") ]))(Dashboard.component);
