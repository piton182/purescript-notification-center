...
(function($PS) {
  ...
  "use strict";
  $PS["Capabilities.CheckInbox"] = $PS["Capabilities.CheckInbox"] || {};
  var exports = $PS["Capabilities.CheckInbox"];                              
  var CheckInbox = function (Monad0, checkInbox) {
      this.Monad0 = Monad0;
      this.checkInbox = checkInbox;
  };
  var checkInbox = function (dict) {
      return dict.checkInbox;
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Capabilities.GenerateData"] = $PS["Capabilities.GenerateData"] || {};
  var exports = $PS["Capabilities.GenerateData"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var GenerateData = function (Monad0, generateSendout) {
      this.Monad0 = Monad0;
      this.generateSendout = generateSendout;
  };
  var generateSendout = function (dict) {
      return dict.generateSendout;
  };
  var generateDataHalogenM = function (dictGenerateData) {
      return new GenerateData(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictGenerateData.Monad0())(generateSendout(dictGenerateData)));
  };
  exports["generateSendout"] = generateSendout;
  exports["GenerateData"] = GenerateData;
  exports["generateDataHalogenM"] = generateDataHalogenM;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
})(PS["FFI.GenerateSendout"] = PS["FFI.GenerateSendout"] || {});
(function(exports) {
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["DataModel"] = $PS["DataModel"] || {};
  var exports = $PS["DataModel"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var showUser = new Data_Show.Show(function (v) {
      return v.id;
  });
  var showMessage = new Data_Show.Show(function (v) {
      return Data_Show.show(Data_Show.showString)(v.id);
  });
  var eqUser = new Data_Eq.Eq(function (v) {
      return function (v1) {
          return v.id === v1.id;
      };
  });
  var ordUser = new Data_Ord.Ord(function () {
      return eqUser;
  }, function (v) {
      return function (v1) {
          return Data_Ord.compare(Data_Ord.ordString)(v.id)(v1.id);
      };
  });
  var eqSendOut = new Data_Eq.Eq(function (v) {
      return function (v1) {
          return v.message.id === v1.message.id;
      };
  });      
  var decodeJsonUser = Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "id";
  }))()())();
  var decodeJsonMesssage = Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "text";
  ...
  var decodeJson = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeJsonString)(json))(function (string) {
          var decodeError = "Could not decode Status from " + string;
          return Data_Either.note(decodeError)((function () {
              if (string === "NONE") {
                  return new Data_Maybe.Just(None.value);
              };
              if (string === "SENT") {
                  return new Data_Maybe.Just(Sent.value);
              };
              if (string === "Received") {
                  return new Data_Maybe.Just(Received.value);
              };
              return Data_Maybe.Nothing.value;
          })());
      });
  });
  var decodeJsonRecipient = Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(decodeJson)(Data_Argonaut_Decode_Class.gDecodeJsonCons(decodeJsonUser)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "user";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "status";
  }))()())();
  var decodeJsonSendOut = Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(decodeJsonMesssage)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(decodeJsonRecipient))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "recipients";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "message";
  }))()())();
  ...
  exports["eqSendOut"] = eqSendOut;
  exports["showUser"] = showUser;
  exports["ordUser"] = ordUser;
  exports["decodeJsonSendOut"] = decodeJsonSendOut;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["FFI.GenerateSendout"] = $PS["FFI.GenerateSendout"] || {};
  var exports = $PS["FFI.GenerateSendout"];
  var $foreign = $PS["FFI.GenerateSendout"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Argonaut_Decode_Class = $PS["Data.Argonaut.Decode.Class"];
  var Data_Argonaut_Parser = $PS["Data.Argonaut.Parser"];
  var Data_Either = $PS["Data.Either"];
  var DataModel = $PS["DataModel"];                
  var generateSendout = function __do() {
      var str = $foreign["_generateSendout"]();
      return Control_Bind.bindFlipped(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(DataModel.decodeJsonSendOut))(Data_Argonaut_Parser.jsonParser(str));
  };
  exports["generateSendout"] = generateSendout;
})(PS);
(function($PS) {
...
(function($PS) {
  ...
  $PS["AppM"] = $PS["AppM"] || {};
  var exports = $PS["AppM"];
  var Capabilities_CheckInbox = $PS["Capabilities.CheckInbox"];
  var Capabilities_GenerateData = $PS["Capabilities.GenerateData"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Reader_Class = $PS["Control.Monad.Reader.Class"];
  ...
  var Effect_Class = $PS["Effect.Class"];
  var FFI_GenerateSendout = $PS["FFI.GenerateSendout"];
  ...
  var generateDataAppM = new Capabilities_GenerateData.GenerateData(function () {
      return monadAppM;
  }, Effect_Class.liftEffect(monadEffectAppM)(FFI_GenerateSendout.generateSendout)); 
  ...
  var checkInboxAppM = new Capabilities_CheckInbox.CheckInbox(function () {
      return monadAppM;
  }, function (user) {
      return Control_Bind.bind(bindAppM)(Control_Monad_Reader_Class.ask(monadAskAppM(Type_Equality.refl)))(function (env) {
          return Control_Applicative.pure(applicativeAppM)(new Data_Maybe.Just([  ]));
      });
  });
  exports["runAppM"] = runAppM;
  exports["checkInboxAppM"] = checkInboxAppM;
  exports["generateDataAppM"] = generateDataAppM;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["TestData"] = $PS["TestData"] || {};
  var exports = $PS["TestData"];
  var DataModel = $PS["DataModel"];                
  var user2 = {
      id: "user2"
  };
  ...
  exports["sendout_dlg123"] = sendout_dlg123;
  exports["sendout_dlg124"] = sendout_dlg124;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Dashboard"] = $PS["Dashboard"] || {};
  var exports = $PS["Dashboard"];
  var Capabilities_CheckInbox = $PS["Capabilities.CheckInbox"];
  var Capabilities_GenerateData = $PS["Capabilities.GenerateData"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var CheckInbox = (function () {
      function CheckInbox(value0) {
          this.value0 = value0;
      };
      CheckInbox.create = function (value0) {
          return new CheckInbox(value0);
      };
      return CheckInbox;
  })();
  var NewSendout = (function () {
      function NewSendout() {

      };
      NewSendout.value = new NewSendout();
      return NewSendout;
  })();
  var render = function (state) {
      var renderRecipientAndInbox = function (inboxes) {
          return function (v) {
              var showInbox = function (v1) {
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return "[]";
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return Data_Show.show(Data_Show.showArray(DataModel.showMessage))(v1.value0);
                  };
                  throw new Error("Failed pattern match at Dashboard (line 96, column 9 - line 96, column 43): " + [ v1.constructor.name ]);
              };
              var inbox = Data_Map_Internal.lookup(DataModel.ordUser)(v.user)(inboxes);
              return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(Data_Show.show(DataModel.showUser)(v.user)) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(showInbox(inbox)), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Events.onClick(function (v1) {
                  return Data_Maybe.Just.create(new CheckInbox(v.user));
              }) ])([ Halogen_HTML_Core.text("(check)") ]) ]) ]);
          };
      };
      var renderNav = (function () {
          var sendout2slug = function (v) {
              return v.message.id;
          };
          var renderNavItem = function (sendout) {
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link" + (function () {
                  var $25 = Data_Eq.eq(DataModel.eqSendOut)(sendout)(state.activeSendout);
                  if ($25) {
                      return " active";
                  };
                  return "";
              })()), Halogen_HTML_Properties.href("#"), Halogen_HTML_Events.onClick(function (v) {
                  return Data_Maybe.Just.create(SwitchTab.create(sendout));
              }) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showString)(sendout2slug(sendout))) ]) ]);
          };
          return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("nav nav-tabs flex-column") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(renderNavItem)(state.sendouts))([ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link"), Halogen_HTML_Properties.href("#"), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(NewSendout.value);
      ...
      var renderSendout = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container-fluid") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ renderMessage(v.message) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.table([ Halogen_HTML_Properties.class_("table") ])(Data_Functor.map(Data_Functor.functorArray)(renderRecipientAndInbox(state.inboxes))(v.recipients)) ]) ]) ]) ]);
      };
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container-fluid") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ renderNav ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-10") ])([ renderSendout(state.activeSendout) ]) ]) ]);
  };
  var initialState = function (v) {
      return {
          activeSendout: TestData.sendout_dlg123,
          sendouts: [ TestData.sendout_dlg123, TestData.sendout_dlg124 ],
          inboxes: Data_Map_Internal.empty
      };
  };
  var handleAction = function (dictCheckInbox) {
      return function (dictGenerateData) {
          return function (v) {
              if (v instanceof SwitchTab) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $33.activeSendout = v.value0;
                      return $33;
                  });
              };
              if (v instanceof CheckInbox) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictCheckInbox.Monad0())(Capabilities_CheckInbox.checkInbox(dictCheckInbox)(v.value0)))(function (inbox) {
                      if (inbox instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (inbox instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              var $38 = {};
                              for (var $39 in st) {
                              ...
                              $38.inboxes = Data_Map_Internal.insert(DataModel.ordUser)(v.value0)(inbox.value0)(st.inboxes);
                              return $38;
                          });
                      };
                      throw new Error("Failed pattern match at Dashboard (line 151, column 5 - line 154, column 72): " + [ inbox.constructor.name ]);
                  });
              };
              if (v instanceof NewSendout) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Capabilities_GenerateData.generateSendout(Capabilities_GenerateData.generateDataHalogenM(dictGenerateData)))(function (newSendout$prime) {
                      if (newSendout$prime instanceof Data_Either.Left) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (newSendout$prime instanceof Data_Either.Right) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              var $45 = {};
                              for (var $46 in st) {
                              ...
                              $45.sendouts = Data_Array.cons(newSendout$prime.value0)(st.sendouts);
                              $45.activeSendout = newSendout$prime.value0;
                              return $45;
                          });
                      };
                      throw new Error("Failed pattern match at Dashboard (line 157, column 5 - line 160, column 99): " + [ newSendout$prime.constructor.name ]);
                  });
              };
              throw new Error("Failed pattern match at Dashboard (line 146, column 16 - line 160, column 99): " + [ v.constructor.name ]);
          };
      };
  };
  var component = function (dictGenerateData) {
      return function (dictCheckInbox) {
          return Halogen_Component.mkComponent({
              initialState: initialState,
              render: render,
              "eval": Halogen_Component.mkEval({
                  handleAction: handleAction(dictCheckInbox)(dictGenerateData),
...
(function($PS) {
  ...
  var main = (function () {
      var rootComponent = function (env) {
          return Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM(env))(Dashboard.component(AppM.generateDataAppM)(AppM.checkInboxAppM));
      };
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref["new"](Data_Map_Internal.empty)))(function (ref) {
              return Halogen_VDom_Driver.runUI(rootComponent({
                  storage: ref
              }))(Data_Unit.unit)(body);
          });
      }));
