...
(function($PS) {
  ...
  var checkInboxAff = new CheckInbox(function () {
      return Effect_Aff.monadAff;
  }, function (v) {
      return Control_Applicative.pure(Effect_Aff.applicativeAff)(DataModel.Inbox([ TestData.message_dlg125 ]));
  });
  ...
  var checkInboxHalogenM = function (dictCheckInbox) {
      return new CheckInbox(function () {
          ...
          var $2 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictCheckInbox.Monad0());
          var $3 = checkInbox(dictCheckInbox);
          return function ($4) {
              return $2($3($4));
          };
      })());
  ...
  exports["checkInboxAff"] = checkInboxAff;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  ...
  var renderNav = function (state) {
      ...
      var renderNavItem = function (sendout) {
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link" + (function () {
              var $17 = Data_Eq.eq(DataModel.eqSendOut)(sendout)(state.activeSendout);
              if ($17) {
                  return " active";
              };
              return "";
  ...
  var render = function (state) {
      var renderRecipientAndInbox = function (inboxes) {
          return function (v) {
              var showInbox = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Dashboard (line 95, column 9 - line 95, column 43): " + [ v1.constructor.name ]);
              };
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container-fluid") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ renderNav(state) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-10") ])([ renderSendout(state.activeSendout) ]) ]) ]);
  };
  ...
  var handleAction = function (dictCheckInbox) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Dashboard (line 102, column 16 - line 107, column 67): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Dashboard.component(Capabilities_CheckInbox.checkInboxAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();