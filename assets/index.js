      ...
      var renderNav = (function () {
          ...
          var renderNavItem = function (sendout) {
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link" + (function () {
                  var $21 = Data_Eq.eq(DataModel.eqSendOut)(sendout)(state.activeSendout);
                  if ($21) {
                      return " active";
                  };
                  return "";
          ...
          return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("nav nav-tabs flex-column") ])(Data_Functor.map(Data_Functor.functorArray)(renderNavItem)(state.sendouts));
      })();
          ...
          if (v instanceof CheckInbox) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Capabilities_CheckInbox.checkInbox(Capabilities_CheckInbox.checkInboxHalogenM(dictCheckInbox))(v.value0))(function (inbox) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $33.inboxes = Data_Map_Internal.insert(DataModel.ordUser)(v.value0)(inbox)(st.inboxes);
                      return $33;
                  });
              });
          };
          throw new Error("Failed pattern match at Dashboard (line 128, column 16 - line 133, column 67): " + [ v.constructor.name ]);
      };
  };
