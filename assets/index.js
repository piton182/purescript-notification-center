...
(function($PS) {
  ...
  var checkInboxHalogenM = function (dictCheckInbox) {
      return new CheckInbox(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, (function () {
          var $1 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictCheckInbox.Monad0());
          var $2 = checkInbox(dictCheckInbox);
          return function ($3) {
              return $1($2($3));
          };
      })());
  ...
  exports["CheckInbox"] = CheckInbox;
  exports["checkInboxHalogenM"] = checkInboxHalogenM;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var showInbox = new Data_Show.Show(function (v) {
      return Data_Show.show(Data_Show.showArray(showMessage))(v);
  });
...
(function($PS) {
  ...
  exports["message_dlg125"] = message_dlg125;
...
(function($PS) {
  ...
  var applicativeAppM = Effect_Aff.applicativeAff;
  var checkInboxAppM = new Capabilities_CheckInbox.CheckInbox(function () {
      return monadAppM;
  }, function (v) {
      return Control_Applicative.pure(applicativeAppM)(DataModel.Inbox([ TestData.message_dlg125 ]));
  });
      ...
      var renderRecipientAndInbox = function (inboxes) {
          return function (v) {
              var showInbox = function (v1) {
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      return Data_Show.show(DataModel.showInbox)(v1.value0);
                  };
                  throw new Error("Failed pattern match at Dashboard (line 92, column 9 - line 92, column 43): " + [ v1.constructor.name ]);
              };
  ...
  var handleAction = function (dictCheckInbox) {
      return function (v) {
          ...
          if (v instanceof CheckInbox) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Capabilities_CheckInbox.checkInbox(Capabilities_CheckInbox.checkInboxHalogenM(dictCheckInbox))(v.value0))(function (inbox) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $34 = {};
                      for (var $35 in st) {
                      ...
                      $34.inboxes = Data_Map_Internal.insert(DataModel.ordUser)(v.value0)(inbox)(st.inboxes);
                      return $34;
                  });
              });
          };
          throw new Error("Failed pattern match at Dashboard (line 138, column 16 - line 143, column 67): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var main = (function () {
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM)(Dashboard.component(AppM.checkInboxAppM));
