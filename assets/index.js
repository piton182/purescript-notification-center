...
(function($PS) {
  ...
  var Renderable = function (render) {
      this.render = render;
  };
  var showStatus = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at DataModel (line 26, column 1 - line 29, column 29): " + [ v.constructor.name ]);
  });
  ...
  exports["rendarableSendOut"] = rendarableSendOut;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  ...
  var renderNav = function (state) {
      ...
      var renderNavItem = function (sendout) {
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("nav-item") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("nav-link" + (function () {
              var $9 = Data_Eq.eq(DataModel.eqSendOut)(sendout)(state.activeSendout);
              if ($9) {
                  return " active";
              };
              return "";
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container-fluid") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ renderNav(state) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col-10") ])([ DataModel.render(DataModel.rendarableSendOut)(state.activeSendout) ]) ]) ]);
  };
...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Dashboard.component)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();